	...
	tests := []struct {
		...
		},
		{
			...
			in: openai.ChatCompletionRequest{
				...
				Temperature: openai.Ptr(float32(2)),
			},
		...
		},
		{
			...
			in: openai.ChatCompletionRequest{
				...
				Temperature: openai.Ptr(float32(1)),
				TopP:        openai.Ptr(float32(0.1)),
			},
			expectedError: openai.ErrReasoningModelLimitationsOther,
		},
		{
		...
		},
		{
			...
			in: openai.ChatCompletionRequest{
				...
				PresencePenalty: openai.Ptr(float32(1)),
			},
			expectedError: openai.ErrReasoningModelLimitationsOther,
		},
		{
			...
			in: openai.ChatCompletionRequest{
				...
				FrequencyPenalty: openai.Ptr(float32(0.1)),
			},
			expectedError: openai.ErrReasoningModelLimitationsOther,
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			in: openai.ChatCompletionRequest{
				...
				PresencePenalty: openai.Ptr(float32(0.1)),
			},
			expectedError: openai.ErrReasoningModelLimitationsOther,
		},
		{
